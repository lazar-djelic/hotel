        ...
        <div className="card  bg-base-100 hover:shadow-lg transition-all duration-200 border-t-8 border-b-2 border-solid">
            <div className="card-body">
                ...
                <div className="card-actions justify-between items-center mt-4">
                    <span className="text-sm text-base-content/60">{formatDate(review.createdAt)}</span>
                    <div className="flex items-center gap-1">
                        ...
                        <button className="btn btn-ghost btn-s text-error" onClick={(e) => handleDelete(e, review._id)}>
